# 大鱼 TT 增强包
## 关于本项目
```大鱼TT``` 是B站UP```大鱼DIY```在2023年发布的一款CoreXY结构的开源3D打印机方案。

大家都习惯把资料在QQ群里讨论分享，但是不方便检索，所以我创建了这个项目，把组装过程中用到的资源，一点点收集到这里。同时也欢迎其他机友补充和提交资料。
...
```
2023年10月16日00:20:50获得的好消息，24V NPN接近开关可以在八爪鱼上使用了，接线方法：正负极接电源正负极，信号PIN还是接Probe的信号PIN就可以用了
```
